...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void didChangeDependencies() {
    ...
    // Precache all heavy onboarding images so they don't pop-in like network images
                      ...
                      children: [
                        ...
                        PageView.builder(
                          ...
                          itemBuilder: (context, pageIndex) {
                            return const SizedBox.shrink(); // Content is now handled by the stack below and the text panel
                          },
                        ),
                      ],
                    ),
