      ...
      children: [
        SellerCriteriaCard(
          items: [
            ...
            SellerCriteriaItem(
              label:
                  '${VerificationCriteria.minFollowers}+ followers',
              detail: '${store.followersCount} followers so far',
              met: store.meetsFollowersCriteria,
            ),
            SellerCriteriaItem(
              label:
                  '${VerificationCriteria.minSellerRating}+ seller rating from ${VerificationCriteria.minRatingCount}+ ratings',
              detail: '${store.sellerRating.toStringAsFixed(1)} average from ${store.totalRatingCount} ratings',
