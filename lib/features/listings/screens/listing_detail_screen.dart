...
class _ListingDetailScreenState extends State<ListingDetailScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      client.viewListing(widget.listing.canonicalId);
    });
  }
  ...
  String get _sellerPhone {
    ...
    return switch (widget.listing.sellerName) {
  ...
  Future<void> _handleRecordSale(
    ...
    // Bot logic removed to prevent untrustworthy local sale confirmations.
    if (!mounted) return;
      ...
      builder: (context, _) {
        ...
        if (isDesktop) {
          bodyContent = Row(
            ...
            children: [
              // Left column: Interactive media gallery and reviews section
              Expanded(
                flex: 5,
                child: SingleChildScrollView(
                  padding: const EdgeInsets.fromLTRB(40, 12, 24, 40),
                  child: Column(
              ...
              // Right column: Product specs, seller card, buyer actions, and CTAs
              Expanded(
                flex: 5,
                child: SingleChildScrollView(
                  padding: const EdgeInsets.fromLTRB(24, 12, 40, 40),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(
                            isOwner ? 'Manage Listing' : 'Contact / Buy Now',
                    ...
                    Row(
                      children: [
                        CircleAvatar(
                          radius: 24,
                          backgroundColor: AppColors.white,
                          backgroundImage: listing.sellerAvatarUrl != null && listing.sellerAvatarUrl!.isNotEmpty
                              ? NetworkImage(MediaUrlResolver.resolve(listing.sellerAvatarUrl!))
                              : null,
                          child: listing.sellerAvatarUrl != null && listing.sellerAvatarUrl!.isNotEmpty
                              ? null
                              : Text(
...
class _ListingPhotoCarouselState extends State<_ListingPhotoCarousel> {
  ...
  Widget build(BuildContext context) {
    ...
    final width = MediaQuery.sizeOf(context).width;
    final isDesktop = width > 800;
    final double aspectRatio = isDesktop ? 1.2 : 1.0;
              ...
              ClipRRect(
                ...
                child: AspectRatio(
                  ...
                  child: photos.length == 1
                      ? GestureDetector(
                          onTap: () => _showFullImageViewer(context, photos, 0),
                          child: ListingImage(
                            source: photos.first,
                            fit: BoxFit.cover,
                            cacheWidth: 600,
                      ...
                      : PageView.builder(
                          ...
                          itemBuilder: (context, index) => GestureDetector(
                            onTap: () => _showFullImageViewer(context, photos, index),
                            child: ListingImage(
                              source: photos[index],
                              fit: BoxFit.cover,
                              cacheWidth: 600,
  ...
  void _showFullImageViewer(BuildContext context, List<String> photos, int initialIndex) {
    Navigator.of(context).push(
      MaterialPageRoute(
        fullscreenDialog: true,
        builder: (context) => _FullImageViewerScreen(
          photos: photos,
...
class _FullImageViewerScreen extends StatefulWidget {
  const _FullImageViewerScreen({
  ...
  @override
  State<_FullImageViewerScreen> createState() => _FullImageViewerScreenState();
}

class _FullImageViewerScreenState extends State<_FullImageViewerScreen> {
