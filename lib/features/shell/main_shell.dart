...
class MainShell extends StatefulWidget {
  ...
  // Global notifier to control active tab index of MainShell
...
class _MainShellState extends State<MainShell> {
  ...
  void initState() {
    super.initState();
    _currentIndex = MainShell.activeTab.value;
    MainShell.activeTab.addListener(_handleTabChange);
  }

  @override
  void dispose() {
    MainShell.activeTab.removeListener(_handleTabChange);
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final showFloatingChrome = !keyboardOpen && !isDesktop;
    ...
    final bodyContent = IndexedStack(index: _currentIndex, children: screens);

    return MainShellScope(
      goToTab: _goToTab,
      child: Scaffold(
        backgroundColor: AppColors.white,
        extendBody: !isDesktop, // Only extend body on mobile to overlay floating bottom bar
        body: Stack(
