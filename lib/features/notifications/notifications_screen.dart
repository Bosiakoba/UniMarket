...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Future<void> _openNotification(
    ...
    store.markReadRemote(notification.id, client: client);

    // Only navigate if the user explicitly tapped the action button in the sheet.
    final didTapAction = await NotificationDetailSheet.show(context, notification);
    if (!context.mounted) return;

    if (didTapAction && notification.hasAction) {
