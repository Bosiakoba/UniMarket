...
enum ListingStatus { active, sold, soldOut, paused, suspended }
...
class SellerListingRecord {
  ...
  ListingStatus get status => switch (listing.lifecycleStatus) {
        ...
        ListingLifecycleStatus.suspended => ListingStatus.suspended,
      };
  ...
  String get statusLabel {
    ...
    return switch (listing.lifecycleStatus) {
      ...
      ListingLifecycleStatus.suspended => 'Suspended',
    };
  }
