...
class UniTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      onChanged: onChanged,
      enabled: enabled,
      style: AppTypography.body(color: enabled ? AppColors.textPrimary : AppColors.textTertiary),
      decoration: InputDecoration(
        ...
        prefixIcon: prefixIcon != null
            ...
            : null,
        filled: true,
        fillColor: enabled ? AppColors.white : AppColors.surfaceMuted,
        contentPadding: const EdgeInsets.symmetric(horizontal: 22, vertical: 18),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(AppSpacing.radiusPill),
          borderSide: BorderSide(color: enabled ? AppColors.border : AppColors.border),
        ),
