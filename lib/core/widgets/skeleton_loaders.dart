...
/// A swinging triple-dot loader animation, shown while content is loading.
class SwingingDots extends StatefulWidget {
  const SwingingDots({super.key, this.size = 10, this.color = AppColors.forestGreen});

  final double size;
  final Color color;

  @override
  State<SwingingDots> createState() => _SwingingDotsState();
}

class _SwingingDotsState extends State<SwingingDots>
    with SingleTickerProviderStateMixin {
  late final AnimationController _controller;
      ...
      builder: (context, _) {
        return Row(
          ...
          children: List.generate(3, (index) {
            ...
            // Sinusoidal swing: small → large → small
            final scale = 0.4 + 0.6 * sin(t * pi);
              ...
              children: [
                Row(
                  children: const [
                    ...
                    Spacer(),
                    SwingingDots(size: 8, color: AppColors.forestGreen),
                  ],
                ),
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                SwingingDots(size: 7, color: AppColors.forestGreen),
              ],
            ),
          ),
        ),
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                return MasonryGridView.count(
                  ...
                  crossAxisSpacing: 14,
                  itemCount: 4,
                  itemBuilder: (_, _) => const _GridListingSkeleton(),
                );
              },
            ),
          ),
