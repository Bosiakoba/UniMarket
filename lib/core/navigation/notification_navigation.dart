...
import '../../features/profile/my_listings_screen.dart';
  ...
  static Future<void> open(
    ...
    switch (notification.type) {
      ...
      case NotificationType.message:
        ...
        final currentUserId = UserSessionScope.of(context).currentUser?.id ?? '';
        
        final thread = await messageStore.getOrFetchThread(
          threadId: targetId,
          client: client,
        ...
        // Instantly mark read
        await messageStore.markRead(thread.id, client: client);
