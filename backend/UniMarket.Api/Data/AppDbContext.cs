...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    public DbSet<CarouselBanner> CarouselBanners => Set<CarouselBanner>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ListingView>().HasIndex(v => new { v.ListingId, v.UserId }).IsUnique();
        modelBuilder.Entity<ListingView>().HasIndex(v => new { v.ListingId, v.IpAddress }).IsUnique();
