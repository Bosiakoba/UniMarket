...
public record ChatDto(
    ...
    bool OtherPartyIsOnline = false,
    DateTime? OtherPartyLastSeenAt = null);

public record SendMessageRequest(string Content, string? ListingId = null);

public record EditMessageRequest(string Content);
public record DeleteMessageRequest(bool ForEveryone = false);
...
public record CampaignRequest(string Subject, string HtmlBody);
...
public record CarouselBannerDto(
    string Id,
    string Title,
    string Subtitle,
    string ImageUrl,
...
public record CreateCarouselBannerRequest(
    string Title,
    string Subtitle,
    string ImageUrl,
    string RoutePath);
